...
let TechnologyAreas = () => { 
    ...
    return (<>
        ...
        <div class="d-flex flex-wrap justify-content-center">
            ...
            {/* <div className="p-2 m-2 border-white">
                <div className="mt-3"><Mail color="white" size={48}/></div>
                <h4>Message Driven</h4>
                <p className="text-white">Asynchronous, responsive software scales better and creates better outcomes for users.</p>                
            </div> */}
            ...
            <div className="p-2 m-2 border-white technology-list-li">
                <a href="https://claytantor.wordpress.com/category/ai-and-big-data/" target="new">
                    ...
                    <h4>Artificial Intelligence and Big Data</h4>
